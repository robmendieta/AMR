...
from amr_srvs.srv import GetPoseLikelihood, GetPoseLikelihoodRequest
...
if __name__ == '__main__':
    ...
    for x, y in product(x_range, y_range):
        request = GetPoseLikelihoodRequest()
        ...
        request.pose.pose.orientation = Quaternion(*q)
        response = get_pose_likelihood(request)
        m.points.append(Point(x=x, y=y))
        scores.append(response.likelihood)
